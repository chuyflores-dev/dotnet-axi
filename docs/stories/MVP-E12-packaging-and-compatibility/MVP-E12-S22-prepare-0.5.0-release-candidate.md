...
One reviewed commit is ready to become `v0.5.0`, with truthful symbol and
...
- User guidance names `0.5.0` and describes only verified symbol discovery,
