...
One reviewed commit is ready to become the feature-complete `v0.9.0` MVP
...
story does not create `v0.9.0`, publish to NuGet, or hide a failing release
gate that must be resolved before 1.0.0.

## Acceptance

- User guidance names `0.9.0` and describes the complete implemented MVP
