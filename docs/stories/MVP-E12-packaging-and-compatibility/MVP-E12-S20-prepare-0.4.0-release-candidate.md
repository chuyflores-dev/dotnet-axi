# MVP-E12-S20 — Prepare the 0.4.0 Release Candidate
...
- [0.4.0 release outcome](../../design/releases.md#planned-capability-milestones)
...
story does not create `v0.4.0`, publish to NuGet, or create a GitHub Release.
...
- The approved candidate pull request is left open and no `0.4.0` release-side
  state exists.
