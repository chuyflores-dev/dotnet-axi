...
- [MVP-E13-S19 — Add 0.5.0 semantic-relationship and graph tasks](MVP-E13-S19-semantic-relationship-corpus.md)
- [MVP-E13-S20 — Measure the 0.5.0 Codex subset](MVP-E13-S20-measure-0.5.0-codex-subset.md)
- [MVP-E13-S21 — Add 0.6.0 analysis and SDK-execution tasks](MVP-E13-S21-analysis-and-sdk-corpus.md)
- [MVP-E13-S22 — Measure the 0.6.0 Codex subset](MVP-E13-S22-measure-0.6.0-codex-subset.md)
- [MVP-E13-S23 — Add 0.7.0 configuration and validation tasks](MVP-E13-S23-configuration-and-validation-corpus.md)
- [MVP-E13-S24 — Measure the 0.7.0 Codex subset](MVP-E13-S24-measure-0.7.0-codex-subset.md)
- [MVP-E13-S25 — Add 0.8.0 safe agent-integration tasks](MVP-E13-S25-safe-agent-integration-corpus.md)
- [MVP-E13-S26 — Measure the 0.8.0 Codex subset](MVP-E13-S26-measure-0.8.0-codex-subset.md)
- [MVP-E13-S27 — Measure the 0.8.0 Claude subset](MVP-E13-S27-measure-0.8.0-claude-subset.md)
- [MVP-E13-S28 — Measure the 0.9.0 Codex release gate](MVP-E13-S28-measure-0.9.0-codex-release-gate.md)
- [MVP-E13-S29 — Measure the 0.9.0 Claude release gate](MVP-E13-S29-measure-0.9.0-claude-release-gate.md)
