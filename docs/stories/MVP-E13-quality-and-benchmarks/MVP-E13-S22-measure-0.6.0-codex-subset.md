# MVP-E13-S22 — Measure the 0.6.0 Codex Subset

## Outcome

A manually dispatched Codex series measures the 0.6.0 analysis and SDK
...
- The report retains complete manifests, metrics, validation, activation,
  effects, and raw-trajectory evidence and separates 0.6.0 results from
  earlier series.
