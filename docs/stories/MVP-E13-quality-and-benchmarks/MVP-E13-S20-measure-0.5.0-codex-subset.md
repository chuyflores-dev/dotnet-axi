# MVP-E13-S20 — Measure the 0.5.0 Codex Subset

## Outcome

A manually dispatched Codex series measures the 0.5.0 semantic-relationship
...
- Every affected 0.5.0 task runs at least five times per baseline and candidate
...
- The report retains complete manifests, metrics, validation, activation, and
  raw-trajectory evidence and separates 0.5.0 results from earlier series.
...
- Normalized results reconcile with raw events, task oracles, versions,
  hashes, activation evidence, and the approved 0.5.0 corpus manifest.
